...
def main() -> None:
    ...
    print("2. Find 'Aprimo DAM Collection Crawler'")
    print("3. Click the blue 'service worker' link")
    print("4. In the Console tab, paste and run:")
    print()
    print(f"await storeAuditSecret('{hex_secret}');")
    print()
